...
import com.hisu.alicloud.gs.dj.webbrowser.manager.UpdateVideoManager;
...
//					String mac = android.os.SystemProperties.get("persist.sys.mmcp.smartcard");
...
//		Toast.makeText(mContext, "�����������磬���Ժ�...", Toast.LENGTH_LONG).show();
		 ...
		 * 0 ���ر�����Ƶ 1 ������
		 */
		mHandler.sendEmptyMessageDelayed(handler, 800);
		mBrowser.clearCache();
...
//		btn_input.requestFocus();
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		Log.e("��ֵ", "" + keyCode+"event:"+event.getKeyCode());
		// TODO Auto-generated method stub
		switch (keyCode) {
...
//			return super.onKeyDown(keyCode, event);
	...
	public boolean dispatchKeyEvent(KeyEvent event) {
		// TODO Auto-generated method stub
		Log.e("键值ֵ", "event:"+event.getKeyCode());
		// back ˫��Ӧ
