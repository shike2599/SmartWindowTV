package com.hisu.alicloud.gs.dj.webbrowser;
...
import com.hisu.alicloud.gs.dj.webbrowser.activity.HisuDialogActivity;
import com.hisu.alicloud.gs.dj.webbrowser.js.PlayerScript;
...
import com.hisu.alicloud.gs.dj.webbrowser.util.BrowserEvent;
		...
		mWebView.setWebViewClient(new WebViewClient() {
			...
			public void onReceivedError(final WebView view, int errorCode,
				...
				if (WebInterface.ERRORACTIVITY) {
					...
					Toast.makeText(mContext, "�����쳣����������", Toast.LENGTH_LONG)
							.show();
					// ac.startActivity(new Intent(ac, DialogActivity.class));
					ac.finish();

				} else {
					Toast.makeText(mContext, "�����쳣����������", Toast.LENGTH_LONG)// 10.10.7.150:8081
							.show();
			...
			public WebResourceResponse shouldInterceptRequest(WebView view,
					String request) {// ��Ҫ���õ���������������������ÿ�ζ�ȡͼƬ��ʱ��ص��� String mimeType, String encoding,
				Log.e("shouldInterceptRequest",request);
//				AssetManager am = ac.getResources().getAssets();
//				InputStream is = null;
//				
//				// String[] helpimgs =
//				// GetAssetsFiles.getfilesFromAssets(mContext, "helpimg");
//				if(request.contains("mp4")){
//					request = Environment.getExternalStorageDirectory().getPath().toString()+"/"+"1.mp4";
////					String substring = request.substring(
////							request.lastIndexOf("/") +1, request.lastIndexOf("."));
////					try {
//						Log.e("substring", request);
////						is = am.open("vods/" + substring + ".mp4");
