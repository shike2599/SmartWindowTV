...
public class UpdateManager {
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(android.os.Message msg) {
			...
			case CHECK_VERSION:
				...
				Log.i(TAG, "CHECK_VERSION result: " + obj.toString());
	...
	private void downloadApk() throws JSONException {
		...
		Log.i(TAG, "downLoadUrl: " + mVersion.getString("downLoadUrl") + ", filePath: " + filePath);
		http.download(mVersion.getString("downLoadUrl"), filePath, true, true,
				new RequestCallBack<File>() {
					...
					public void onFailure(HttpException error, String msg) {
						Log.i(TAG, TAG + ": onFailure===" + msg + "===err: " + error.toString());
						mHandler.sendEmptyMessage(DOWNLOAD_FAILED);
					}
