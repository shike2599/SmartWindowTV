...
import com.hisu.alicloud.gs.dj.webbrowser.activity.UpathActivity;
import com.hisu.alicloud.gs.dj.webbrowser.activity.VideoVLCActivity;
import com.hisu.alicloud.gs.dj.webbrowser.manager.UpdateManager;
...
import com.hisu.alicloud.gs.dj.webbrowser.util.ToolsUtil;
...
public class SystemScript {
	...
	// ���൳�����л�
	// ���������кŻ�ȡ����ʾ����
	// import android.util.TerminalInfo;
	// TerminalInfo.getSerialNo()
	@JavascriptInterface
	public String getSequenceNumber() {
		// return android.util.TerminalInfo.getSerialNo();

		Class<?> c;
		String invoke = null;
		try {
			// ͨ�������ȡ���к�
			c = Class.forName("android.util.TerminalInfo");

			Constructor con = c.getConstructor();
			Object obj = con.newInstance();

			Method method = c.getMethod("getSerialNo");
			invoke = (String)method.invoke(obj);
	...
	// ���൳�� ����ֱ��
	@JavascriptInterface
	public void openLaucherVideoForAction(String action) {
	...
	public String getCaCardAddress() {
		try {
			Class<?> proClass = Class.forName("android.os.SystemProperties");
			Method method = proClass.getMethod("get", String.class);
