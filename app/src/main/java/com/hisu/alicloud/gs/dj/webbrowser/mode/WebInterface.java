...
//	public static  String URL_PREFIX = "http://101.200.167.125:8189";//Т��   dj.hisugj.com
	public static  String URL_PREFIX = "http://ott.vistone.net";
	
	
	public static  String URL_VERSION = "http://ott.vistone.net";
	/*
	 * versionCode 10
	 * */
...
//		return "http://222.23.86.91";
	}
	public static String URL_APP_VERSION(){
		return URL_VERSION +"/SmartHotelInterface/api/smartHotel/checkAppVersion";
	}
	public static String URL_CACHE_VIDEO(){ 
		return URL_VERSION+"/SmartHotelInterface/api/smartHotel/cacheVideos";
	}
	/*
	 * ����ϵͳ������Ƶ
	 * */
